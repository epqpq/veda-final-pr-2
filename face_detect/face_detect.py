...
# person1_image = face_recognition.load_image_file("test_images/dong_stand.jpg")
...
for images in os.listdir(path):
    ...
    known_face_names.append(images.split('_')[0])
    # print(images.split('_')[0])
...
while True:
    ...
    if threshold == 30:
        if good > bad:
            ...
            # pwm.ChangeFrequency(266)
            #pwm.start(0.1)
            flag = 1
        elif bad > good:
            GPIO.output(25, GPIO.HIGH)
            # pwm.ChangeFrequency(130)
            #pwm.start(0.1)
            flag = 1
        threshold = 0
        good = 0
